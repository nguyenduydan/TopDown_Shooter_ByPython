...
# fonts
font = pygame.font.Font("assests/font/PublicPixel.ttf", 20)
small_font = pygame.font.Font("assests/font/PublicPixel.ttf", 15)
title_font = pygame.font.Font("assests/font/PublicPixel.ttf", 60)
score_font = pygame.font.Font("assests/font/PublicPixel.ttf", 50)

# loads imgs
background = pygame.image.load("data/tmx/Map.png").convert()
plain_bg = pygame.image.load("assests/background/black bg.png").convert()
coin_imgs = import_folder("assests/items/coin")

#bullet_img = pygame.image.load("bullets/bluebullet.png").convert_alpha()
bullet_img = pygame.image.load("assests/bullet/0.png").convert_alpha()
...
class Player(pygame.sprite.Sprite):
    def __init__(self, pos):
        super().__init__()
        self.image = pygame.image.load("assests/player/0.png").convert_alpha()
...
class Enemy(pygame.sprite.Sprite):
    ...
    def animate(self, index, animation_speed, sprite, animation_type):
        if len(sprite) > 0:
            index = (index + animation_speed) % len(sprite)
        else:
            index = 0
        ...
        if animation_type == "hunt" or animation_type == "idle" or animation_type == "death":
            if self.velocity.x < 0:
...
class UI():
    ...
    def display_coin(self):
        coin_image = pygame.image.load("assests/items/coin/0.png").convert_alpha()
...
necromancer_image = pygame.image.load("enemy/necromancer/sprites/sprite_00.png").convert_alpha()
...
nightborne_image = pygame.image.load("enemy/nightborne/sprites/00.png").convert_alpha()
